...
Layout: title, abstract and keywords span the Chinese panel. All other translation uses two columns. Supplements follow their paragraph and flow naturally across columns/pages. Preserve source references without translating them. Keep fixed readable type and compact spacing. Reserve the unchanged responsibility statement on the physical last page. See [layout policy](references/layout-policy.md).
