...
1. **Warning**
   ...
   - Repair: A private apology, acknowledgement of responsibility, or
     clarification of expectations may be requested.
2. **Temporarily Limited Activities**
   - Event: A repeated violation or the first incidence of a more serious
     violation.
   - Consequence: A private warning with a time-limited cooldown period.
   - Repair: Reflection, apology, and a thoughtful return to community spaces.
3. **Temporary Suspension**
   - Event: A pattern that warnings have not resolved, or one serious violation.
   - Consequence: A private suspension with conditions for return.
   - Repair: Respecting the suspension and meeting the return conditions.
4. **Permanent Ban**
   - Event: A repeated pattern that other steps failed to resolve, or a violation
     so serious that safety cannot otherwise be maintained.
...
officially represents the community in public or other spaces.
