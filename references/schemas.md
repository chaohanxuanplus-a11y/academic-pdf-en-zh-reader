...
Use the existing full JSON schema only for advanced red emphasis or ambiguity annotations. Frame-graph/layout artifacts are version 2.0.0; Agents never write geometry.
